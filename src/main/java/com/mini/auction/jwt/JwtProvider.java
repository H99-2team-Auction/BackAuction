...
public class JwtProvider {
    ...
    public JwtProvider(UserDetailsServiceImpl userDetailServiceImp, RefreshTokenRepository refreshTokenRepository) {
        this.key = Keys.hmacShaKeyFor(SECRET.getBytes());
        this.userDetailsServiceImpl = userDetailServiceImp;
